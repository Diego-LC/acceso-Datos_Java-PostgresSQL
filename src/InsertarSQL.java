...
public class InsertarSQL {
    ...
    public void insertarDatosSQL(int usuarioId, Connection conn, String sql) {
        try (Statement stmt = conn.createStatement()) {
            stmt.executeUpdate(sql);
            System.out.println("Datos insertados...");
            MostrarBD mostrar = new MostrarBD();
            mostrar.mostrarDatosDB("SELECT * FROM Reserva WHERE rut = " + usuarioId, conn);
            System.out.println(" ");
    ...
    void insertarEnBD(Scanner scanner) {
        ...
        try (Statement stmt = conn.createStatement()) {
            ...
            insertarDatosSQL(usuarioId, conn, sql);
        } catch (SQLException se) {
    ...
    void actualizarEnBD(Scanner scanner, String reservaId) {
        ...
        try (Statement stmt = conn.createStatement()) {
            ...
            "SET rut = " + usuarioId + ", fecha_entrada = '" + fechaEntrada + "', fecha_salida = '" + fechaSalida +
